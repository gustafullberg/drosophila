...
eval_param_t param =
{
    ...
    .mobility = {
        .knight  = { -9, -7, -2,  0,  1,  3,  2,  4,  4 },
        .bishop  = { -7, -6, -5, -3, -1,  0,  1,  3,  3,  2,  3,  1,  2,  1 },
        .rook_o  = { -6, -2, -1, -3, -3, -2, -2, -1,  0,  2,  2,  2,  1,  2,  2 },
        .rook_e  = { -6, -5, -2,  1,  4,  4,  6,  7,  8,  9, 10, 10, 10,  9,  8 },
