...
eval_param_t param =
{
    ...
    .mobility = {
        .knight  = { -7, -3, -2, -1,  0,  1,  2,  3,  2 },
        .bishop  = { -6, -5, -3, -3, -2,  0,  0,  1,  1,  1,  1,  1,  0, -1 },
        .rook_o  = { -3, -1,  0,  0,  0,  0,  0,  0,  1,  1,  2,  2,  2,  3,  1 },
        .rook_e  = { -8, -6, -4, -4, -2,  0,  2,  2,  4,  5,  5,  6,  7,  6,  2 },
        .queen_o = {  3, -4, -2, -1, -2, -1, -2, -2, -1, -1,  0,  0,  0,  1,  2,  2,  4,  3,  4,  4,  6,  9,  8,  8,  8,  3,  4,  3 },
        .queen_e = {-10, -9, -7,-10, -8, -9, -5, -2, -2, -1, -2,  0,  3,  6,  5,  8,  7,  8,  7,  8,  6,  3,  4, -9, -8,-10,  0,-10 },
    },
    .tropism = {
        .knight  = {  0,  1,  2,  2,  0,  0,  0,  1 },
        .bishop  = {  0,  0,  2,  1,  1,  0,  1,  0 },
        .rook    = {  0,  3,  3,  3,  2,  0,  0,  0 },
        .queen   = {  0, 10,  9,  4,  1,  0,  0,  0 },
    },
    .positional = {
        .pawn_guards_minor             = 2,
        .pawn_guards_pawn              = 2,
        ...
        .tempo                         = 1,
        .pawn_passed_scaling = {  0, 14, 32, 65, 116, 177, 256,  0 },
    }
};
