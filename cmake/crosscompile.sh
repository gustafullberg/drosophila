...
mkdir -p win64
cd win64
cmake ../.. -DTARGET_SUFFIX="win64" -DCMAKE_C_FLAGS="-mpopcnt" -DCMAKE_TOOLCHAIN_FILE=../../cmake/win64.cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=../${INSTALL_DIR}
make install
cd ..
...
mkdir -p linux64
cd linux64
cmake ../.. -DTARGET_SUFFIX="linux64" -DCMAKE_C_FLAGS="-m64 -mpopcnt" -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=../${INSTALL_DIR}
make install
cd ..
